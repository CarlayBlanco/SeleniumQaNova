...
public class Logeo {
    ...
    public void CasoLogin1(String usuario, String clave) throws ParseException {
        ...
        cargaInformacion.rellenarCampoTexto("Prueba 4 Carlay Blanco");
        cargaInformacion.rellenarCampoCorreo("carlay.blanco@externos.bci.cl");//Agregada para evaluación 4
        cargaInformacion.rellenarCampoAreaTexto("Esta es le evaluacion numero 4 realizada por Carlay Blanco");
