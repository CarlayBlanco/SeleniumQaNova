...
public class CargaInformacion {
    ...
    @FindBy(id = "imPgTitle")//se corrige el id el cual estaba mal escrito
    private WebElement titulo;

    @FindBy(xpath = "//input[@id='imObjectForm_1_2']")
    private WebElement campoTexto;

    //Agrego este elemento faltante para la evaluacion del ejercicio 3
    ...
    //Se agrega esta funcion faltante para el ejercico 3
